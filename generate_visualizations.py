...
autolabel(rects2)
plt.tight_layout()
plt.savefig('project_visualizations/1_mre_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('project_visualizations/2_self_loop_probability.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('project_visualizations/3_block_matrix_visualization.png', dpi=300, bbox_inches='tight')
plt.close()
...
fig.tight_layout()  
plt.savefig('project_visualizations/4_mu_grid_search.png', dpi=300, bbox_inches='tight')
plt.close()

print("Visualizations successfully generated in 'project_visualizations' directory.")