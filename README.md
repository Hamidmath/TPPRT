...
│
├── pipeline/                        # Data processing pipeline (run in order)
...
│
├── analysis/                        # Evaluation, tuning, smoothing justification
│   ├── evaluate.py                  #   Comprehensive multi-metric evaluation (49 frames)
...
│   ├── popularity_results_smoothed_026.npz  # Smoothed (gamma=0.26)
│   └── two_phase_pagerank_vector.json       # Final PageRank output
│
├── results/                         # Experiment output logs & JSON
│
├── figures/                         # All generated figures
│   ├── paper/                       #   Publication figures (16 figs, PDF+PNG)
│   │   └── generate_figures.py      #   Script to regenerate
│   ├── smoothing/                   #   Smoothing justification & gamma CV plots
...
# Parameter tuning
python analysis/tune_params.py --num-frames 10
python analysis/tune_params.py --mu 10,15,20,25 --damping 0.75,0.80,0.85

# Smoothing justification
python analysis/analyze_smoothing.py
python analysis/optimize_gamma.py
