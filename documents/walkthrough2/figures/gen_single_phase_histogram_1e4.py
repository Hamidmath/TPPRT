...
the geometric reference drops below 10^-4 (instead of 10^-6).
"""
import os
import matplotlib
matplotlib.use("Agg")
...
def main():
    ...
    out_pdf = os.path.join(HERE, "single_phase_histogram_1e4.pdf")
    out_png = os.path.join(HERE, "single_phase_histogram_1e4.png")
    fig.savefig(out_pdf)
