"""Old-form TP tuning focused on the Fair morning-rush hour and region.

Setup (locked):
  pairs  : (t, t+7d) for t = 2018-09-12 08:00, 08:05, ..., 08:55  (12 pairs)
  input  : diffused popularity at t   (Sep 12)
  target : diffused popularity at t+7d (Sep 19, same clock time)
...
Output: results/tp_old_fair_region_hour_W08.json
"""
import json
import os
import sys
...
OUT = RESULTS / "tp_old_fair_tight_hour_W08.json"

EPS = 1e-6
TOL, MAX_ITER = 1e-6, 200
PAIRS = [(f"2018-09-12 08:{m:02d}:00", f"2018-09-19 08:{m:02d}:00")
          for m in range(0, 60, 5)]

# 7 OSM link IDs within 1 km road-graph distance of center 59063;
# tight sub-region of the 39-link Fair-anomaly component. See
# documents/walkthrough2/results/anomalies/fair/tight_region.json
REGION_LINK_IDS = [
...
def main():
    ...
    print(f"  pairs: {len(inputs)}  (each is 1 slot, Sep 12 08:MM -> Sep 19 08:MM)")
