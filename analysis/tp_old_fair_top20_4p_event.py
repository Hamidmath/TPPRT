...
OUT = RESULTS / "tp_old_fair_top20_4p_event.json"
...
# Tue-Thu of W1+W3+W4 (Sep 4-6, 18-20, 25-27) -- the 3 non-Fair weeks.
# Union with the 7 anomaly-lift links yields the same 20 (all 7 are in
# the top 20). See
