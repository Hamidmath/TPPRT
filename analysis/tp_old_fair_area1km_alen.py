...
OUT = RESULTS / "tp_old_fair_area1km_alen.json"
...
# All 104 road links within 1 km road-graph distance of center 59063
# (a surface street in the Fairpark interchange area). Includes the 7
# top-lift Fair-anomaly links. See
# documents/walkthrough2/results/anomalies/fair/area_1km_all.json
REGION_LINK_IDS = [
    "59063","77397","77396","77400","77394","77395","77402","72971",
    "77404","59064","77398","59056","77399","59059","63959","85822",
    "89589","89588","77401","59060","77391","77403","43964","59062",
    "59065","59061","43966","59058","83322","43965","59057","43967",
    "84734","77393","77405","43962","17507","72325","85821","85820",
    "59055","85818","83323","63957","72970","59068","85819","72324",
    "17512","43963","82435","645","63958","61198","77392","72327",
    "55380","59049","43961","17508","72326","54890","17509","55379",
    "77406","646","82345","2747","63964","17510","82436","17511",
    "3614","69772","82346","61200","89582","644","57199","647",
    "57198","82434","77407","61199","89581","82347","57197","641",
    "82694","82348","94443","89583","57200","642","76229","43958",
    "82695","82696","643","86674","91172","76230","43959","69769",
]
...
def main():
    t0 = time.time()
    print("[start] OLD-form TP, Fair 1 km area (104 links), Sep 11 16-17, "
          "tune (alpha, beta, alpha_s, alpha_l, alpha_len)")
    ...
    def loss_full(alpha, beta, a_s, a_l, a_len):
        P = get_kernel(a_s, a_l, a_len)
        region_mre, full_ov = [], []
        ...
        if n_calls[0] % 5 == 0:
            print(f"    eval {n_calls[0]:4d}  a={alpha:.3f} b={beta:.3f} "
                  f"a_s={a_s:+.3f} a_l={a_l:+.3f} a_len={a_len:+.3f}  "
    ...
    def loss(x):
        return loss_full(float(x[0]), float(x[1]), float(x[2]),
                          float(x[3]), float(x[4]))[0]

    BOUNDS = [(0.01, 0.15), (0.01, 0.15),
              (None, None), (None, None), (None, None)]
    STARTS = [
        # alpha, beta, alpha_s, alpha_l, alpha_len
        [0.05, 0.05,  0.0,  0.0,  0.0],
        [0.15, 0.15,  1.0,  0.5,  0.5],
        [0.05, 0.10,  2.65, 0.17, 0.0],
        [0.10, 0.10, -1.0, -1.0,  1.0],
        [0.15, 0.05,  3.0,  1.0, -0.5],
    ...
    a_opt, b_opt, as_opt, al_opt, alen_opt = best["x_opt"]
    f_opt, region_mre, full_ov = loss_full(a_opt, b_opt, as_opt, al_opt, alen_opt)
    summary = dict(
        model="old-form TP, classical PageRank style, with alpha_len",
        scope="Fair 1 km area (104 links), Sep 11 16:00-17:00",
        region_link_ids=region_lids,
        region_n_mapped=int(len(region_idx)),
        pairs=PAIRS,
        bounds=dict(alpha=[0.01, 0.15], beta=[0.01, 0.15],
                     alpha_s=None, alpha_l=None, alpha_len=None),
        starts=runs,
        best=best,
        best_params=dict(alpha=a_opt, beta=b_opt,
                          alpha_s=as_opt, alpha_l=al_opt, alpha_len=alen_opt),
    ...
    print(f"  best: alpha={a_opt:.4f}  beta={b_opt:.4f}  "
          f"alpha_s={as_opt:+.3f}  alpha_l={al_opt:+.3f}  alpha_len={alen_opt:+.3f}")
