...
Saves: results/ladder_eval_pro.json
"""
import json
import os
import random
...
def main():
    ...
    sp_tuned = load_tuned(RESULTS / "sp_tune_pro.json",
                          {"x_opt": [ALPHA_GEOM, 0.0, 0.0], "f_opt": None})
    tp_tuned = load_tuned(RESULTS / "tp_tune_pro.json",
    ...
    for seed in SEEDS:
        ...
        with open(RESULTS / "ladder_eval_pro.json", "w") as f:
            json.dump({
